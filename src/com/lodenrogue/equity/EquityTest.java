...
public class EquityTest {
	...
	public static void main(String[] args) {
		...
		hand1[0] = new Card(Rank.EIGHT, Suit.HEART);
		hand1[1] = new Card(Rank.EIGHT, Suit.CLUB);
		hand1[2] = new Card(Rank.EIGHT, Suit.CLUB);
		hand1[3] = new Card(Rank.KING, Suit.CLUB);
		hand1[4] = new Card(Rank.TWO, Suit.CLUB);

		hand2[0] = new Card(Rank.EIGHT, Suit.HEART);
		hand2[1] = new Card(Rank.EIGHT, Suit.CLUB);
		hand2[2] = new Card(Rank.EIGHT, Suit.CLUB);
		hand2[3] = new Card(Rank.KING, Suit.CLUB);
		hand2[4] = new Card(Rank.ACE, Suit.CLUB);
